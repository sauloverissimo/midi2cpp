 ...
 *
 * Identification:
 *   USB VID:PID         0xCAFE:0x4092   (TinyUSB educational VID + project PID)
 *   Manufacturer string midi2.diy
 *   Product string      ESP32P4Bridge
 *
 * Configuration:
...
static char const *string_desc_arr[] = {
    ...
    "ESP32-P4 Bridge MIDI 2.0",             /* 2: Product                        */
    "ESP32P4Bridge-0001",        /* 3: Serial (static fallback)       */
};
