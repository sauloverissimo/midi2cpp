...
static constexpr uint16_t kModel             = 0x0013;   // fleet-unique (devices use 0x0001..0x0012)
static constexpr uint32_t kVersion           = 0x00010000;
static constexpr const char* kEndpointName     = "ESP32-P4 Bridge MIDI 2.0";
static constexpr const char* kProductInstance = "ESP32P4Bridge-0001";

// MIDI-CI category backing. ci.begin defaults to ciCat 0x1C (Profile |
// Property Exchange | Process Inquiry); every advertised category answers.
static const uint8_t kProfileId[5] = {0x7E, 0x00, 0x00, 0x01, 0x00};   // GM 1
static const char kDeviceInfo[] =
    "{\"manufacturerId\":[125,0,0],\"familyId\":[1,0],\"modelId\":[19,0],"
     "\"versionId\":[0,0,4,0],\"manufacturer\":\"midi2.diy\","
     "\"family\":\"Bridge\",\"model\":\"ESP32-P4 Bridge MIDI 2.0\","
     "\"version\":\"0.0.1\"}";
...
extern "C" void app_main(void) {
    ...
    g_ci.addProfile(kProfileId, /*alwaysOn*/ false);
    g_ci.addPropertyStatic("DeviceInfo",  kDeviceInfo);
    g_ci.addPropertyStatic("ChannelList", kChannelList);
    g_ci.addPropertyStatic("ProgramList", kProgramList);
    g_ci.setMidiReport(/*msg_data_control*/ 0x01,
