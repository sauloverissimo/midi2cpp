/*
 * main.cpp: sparkfun-promicro-rp2350-midi2-showcase
 *
...
static const char     kEndpointName[]   = "RP2350ProMicro";
static const char     kProductInstId[]  = "RP2350ProMicro-showcase-0001";
...
int main() {
    ...
    std::printf("\r\n===========================================\r\n");
    std::printf("  sparkfun-promicro-rp2350-midi2-showcase  (VID:PID 0xCAFE:0x4075)\r\n");
    std::printf("===========================================\r\n");
