// midi2cpp / teensy41-midi2: USB string descriptor override
//
...
// Product so the device announces itself as a midi2cpp showcase while
// keeping VID/PID 0x16C0:0x0485 (the Teensyduino slot for
