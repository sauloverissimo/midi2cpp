/*
 * weact_blackpill_f411_midi2.h, public API of the
 * weact-STM32F411CEU6-blackpill-device-midi2 board core.
 *
...
// On-board LED (PC13, active-low; the BSP handles the inversion). Lit
// while USB is mounted, off otherwise.
