/*
 * usb_descriptors.c, USB Device descriptors for ra4m1-weact-device-midi2.
 *
 * Identification:
 *   USB VID:PID         0xCAFE:0x40F2   (TinyUSB educational VID + project PID)
 *   Manufacturer string github.com/sauloverissimo
 *   Product string      WeActRA4M1
 *
 * Configuration:
 *   1 MIDI 2.0 class interface (Audio Control + MIDI Streaming, Alt 0
 *   MIDI 1.0 fallback + Alt 1 UMP). No CDC, no other classes; RA4M1
 *   resources are tight (32 KB SRAM).
 */
#include <string.h>
#include "tusb.h"
