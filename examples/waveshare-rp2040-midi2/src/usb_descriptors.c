/*
 * usb_descriptors.c: USB Device descriptors for waveshare-rp2040-midi2.
 *
 * Identification:
 *   USB VID:PID         0xCAFE:0x4072   (TinyUSB educational VID + project PID)
 *   Manufacturer string midi2.diy
 *   Product string      RP2040PiZero
 *
 * Configuration:
...
static char const *string_desc_arr[] = {
    ...
    "Waveshare RP2040 Pi Zero MIDI 2.0", /* 4: Group Terminal Block name      */
};
