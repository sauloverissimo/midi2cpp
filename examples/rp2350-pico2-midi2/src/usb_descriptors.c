...
static char const *string_desc_arr[] = {
    ...
    "RP2350 Pico 2 MIDI 2.0",             /* 2: Product                        */
    NULL,                         /* 3: Serial, computed at runtime   */
    "RP2350 Pico 2 MIDI 2.0",     /* 4: Group Terminal Block name      */
};
