/*
 * rp2350-pico2-midi2-showcase: full-surface USB MIDI 2.0 device showcase, ~22 s scene cycle
 * while mounted.
 *
...
static const uint16_t kModelId       = 0x0007;
...
static void install_ci_bootstrap(m2ci& ci) {
    ...
    rc = ci.addPropertyStatic("DeviceInfo",
        "{\"manufacturerId\":[125,0,0],\"familyId\":[1,0],\"modelId\":[7,0],\"versionId\":[0,0,4,0],\"manufacturer\":\"midi2.diy\","
         "\"family\":\"RP2350\","
         "\"model\":\"RP2350 Pico 2 MIDI 2.0\","
         "\"version\":\"0.0.1\"}");
...
int main() {
    ...
    std::printf("\r\n===========================================\r\n");
    std::printf("  rp2350-pico2-midi2-showcase  (VID:PID 0xCAFE:0x4075)\r\n");
    std::printf("===========================================\r\n");
