...
static const uint16_t kModelId         = 0x000F;
...
static void install_ci_bootstrap(m2ci& ci) {
    ...
    rc = ci.addPropertyStatic("DeviceInfo",
        "{\"manufacturerId\":[125,0,0],\"familyId\":[1,0],\"modelId\":[15,0],\"versionId\":[0,0,4,0],\"manufacturer\":\"midi2.diy\","
         "\"family\":\"ESP32-S3\","
         "\"model\":\"ESP32-S3 DevKitC MIDI 2.0\","
         "\"version\":\"0.0.1\"}");
