/*
 * esp32_s3_devkitc_midi2.h, public API of the esp32-s3-devkitc-usb-midi2
 * board core.
 *
...
// On-board RGB LED feedback (GPIO48 WS2812). Green pulse when mounted,
// red when not mounted. Optional, callable from the main loop.
