/*
 * usb_descriptors.c, USB Device descriptors for
 * esp32-s3-devkitc-usb-midi2.
 *
 * Identification:
 *   USB VID:PID         0xCAFE:0x4090   (TinyUSB educational VID + project PID)
 *   Manufacturer string midi2.diy
 *   Product string      ESP32S3DevKitC
 *
 * Configuration:
...
static char const *string_desc_arr[] = {
    ...
    "ESP32-S3 DevKitC MIDI 2.0",             /* 2: Product                        */
    "ESP32S3DevKitC-0001",        /* 3: Serial (static fallback)       */
    "ESP32-S3 DevKitC MIDI 2.0",  /* 4: Group Terminal Block name      */
};
