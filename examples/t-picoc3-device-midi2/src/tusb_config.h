/*
 * tusb_config.h — TinyUSB configuration for t-picoc3-device-midi2 (LilyGO T-PicoC3, RP2040 side)
 *
...
/* Enable MIDI 2.0 Device class driver (from our fork). */
#define CFG_TUD_MIDI2         1

/* MIDI 2.0 config
 * 1 Function Block covering all groups is the common simple setup. */
