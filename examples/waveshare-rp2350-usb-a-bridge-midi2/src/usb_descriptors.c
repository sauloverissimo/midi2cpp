/*
 * usb_descriptors.c: USB Device descriptors for the Waveshare
 * RP2350-USB-A bridge.
 *
 * Identification:
 *   USB VID:PID         0xCAFE:0x4077   (TinyUSB educational VID + bridge PID)
 *   Manufacturer string midi2.diy
 *   Product string      waveshare-RP2350-USB-A bridge
 *
 * Configuration:
...
static char const *string_desc_arr[] = {
    ...
    "RP2350 USB-A Bridge MIDI 2.0", /* 2: Product                     */
    NULL,                         /* 3: Serial, computed at runtime   */
    "RP2350 USB-A Bridge MIDI 2.0", /* 4: Group Terminal Block name      */
};
