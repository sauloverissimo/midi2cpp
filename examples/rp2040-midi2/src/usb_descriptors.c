/*
 * usb_descriptors.c: USB Device descriptors for rp2040-midi2 core.
 *
 * Identification:
 *   USB VID:PID         0xCAFE:0x4070   (TinyUSB educational VID + project PID)
 *   Manufacturer string midi2.diy
 *   Product string      rp2040-midi2
 *
 * Configuration:
...
static char const *string_desc_arr[] = {
    ...
    "RP2040 MIDI 2.0",            /* 4: Group Terminal Block name      */
};
