/*
 * usb_descriptors.c: USB Device descriptors for waveshare-rp2350-usb-a-midi2.
 *
 * Identification:
 *   USB VID:PID         0xCAFE:0x4076   (TinyUSB educational VID + project PID)
 *   Manufacturer string midi2.diy
 *   Product string      waveshare-RP2350-USB-A
 *
 * Configuration:
...
static char const *string_desc_arr[] = {
    ...
    "Waveshare RP2350-USB-A MIDI 2.0",     /* 2: Product                        */
    NULL,                         /* 3: Serial, computed at runtime   */
    "Waveshare RP2350-USB-A MIDI 2.0", /* 4: Group Terminal Block name      */
};
