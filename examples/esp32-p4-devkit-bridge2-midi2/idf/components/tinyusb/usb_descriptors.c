 ...
 *
 * Identification:
 *   USB VID:PID         0xCAFE:0x4095   (TinyUSB educational VID + project PID)
 *   Manufacturer string midi2.diy
 *   Product string      ESP32P4Bridge2
 *
 * Configuration:
...
static char const *string_desc_arr[] = {
    ...
    "ESP32-P4 Bridge2 MIDI 2.0",            /* 2: Product                        */
    "ESP32P4Bridge2-0001",       /* 3: Serial (static fallback)       */
};
