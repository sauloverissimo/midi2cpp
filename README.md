...
25 recipes ship under [`examples/`](examples/), grouped by build path:
...
By role: 14 device, 5 host, 4 bridge, 1 multi-transport (BLE + ESP-NOW, no USB PID), 1 deterministic UMP test bench.
